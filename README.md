...
| Модуль | Уроки | Темы |
|--------|-------|------|
| 🐧 [Терминал и Linux](lessons/module1-terminal/) | 1–8 | Команды, файлы, chmod, chown, пользователи, SSH |
| 🌿 [Git и GitHub](lessons/module2-git/) | 9–11 | Версии, ветки, GitHub |
...
| [killercoda.com](https://killercoda.com) | Kubernetes без установки |
| [learngitbranching.js.org](https://learngitbranching.js.org) | Визуальный Git |
| [linuxsurvival.com](https://linuxsurvival.com) | Симулятор терминала |

---

<div align="center">
MIT License · Используй свободно, учи других! 🚀
</div>
