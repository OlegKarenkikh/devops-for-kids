...
| Раздел | Быстрый переход |
|--------|----------------|
| 🐧 Linux / Bash | [→ перейти](#-linux--bash) |
| 🌿 Git | [→ перейти](#-git) |
| 🐳 Docker | [→ перейти](#-docker) |
| 🎼 Docker Compose | [→ перейти](#-docker-compose) |
| ⚙️ Kubernetes | [→ перейти](#️-kubernetes-kubectl) |
| 🔢 Права chmod | [→ перейти](#-права-доступа-chmod) |
| 🎯 Самопроверка | [→ перейти](#-быстрая-самопроверка) |
